...
##            -0.9573119            -0.7752930             0.8634966
\end{verbatim}
\begin{alltt}
        \hlstd{corr_ZG_MFA}\hlopt{$}\hlstd{rankcorrelation}
\end{alltt}
\begin{verbatim}
##        CS Rank Correlation RankScore Rank Correlation 
##                  0.9646826                  0.6048734
\end{verbatim}
\begin{alltt}
        \hlstd{corr_MFA_FABIA}\hlopt{$}\hlstd{rankcorrelation}
\end{alltt}
\begin{verbatim}
##        CS Rank Correlation        GS Rank Correlation 
##                 -0.5693159                 -0.7996527 
## RankScore Rank Correlation 
##                  0.3512829
\end{verbatim}
\end{kframe}\begin{figure}[H]
